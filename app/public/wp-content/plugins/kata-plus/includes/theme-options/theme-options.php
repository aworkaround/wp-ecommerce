...
if ( ! class_exists( 'Kata_Plus_Theme_Options' ) ) {
	class Kata_Plus_Theme_Options {
		...
		public function actions() {
			add_action( 'customize_register', array( $this, 'change_wp_customizer' ), 100 );
